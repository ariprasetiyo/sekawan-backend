...
import (
	"context"
	handle_auth "sekawan-backend/app/main/handle_auth"
...
func main() {
	...
	authGenerateTokenHandler := handle_auth.NewAuthGenerateTokenHandler(&database)
	authValidateTokenHandler := handle_auth.NewAuthValidateTokenHandler(&database)
