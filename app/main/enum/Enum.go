...
const (
	...
	TYPE_REQUEST_HTTP_UPLOAD_MD5_IMAGE_TEST REQ_TYPE = 204
...
var (
	STRING_TO_REQ_TYPE = map[string]REQ_TYPE{
		...
		"TYPE_REQUEST_HTTP_UPLOAD_MD5_IMAGE_TEST": TYPE_REQUEST_HTTP_UPLOAD_MD5_IMAGE_TEST,
	}
...
func (reqType REQ_TYPE) String() string {
	c := REQ_TYPE_TO_STRING[reqType]
	return c
}

func (respCode RESP_CODE) String() string {
	c := RESPONSE_CODE_TO_STRING[respCode]
	return c
}
