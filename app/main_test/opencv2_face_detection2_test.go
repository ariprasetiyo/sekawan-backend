...
func TestOpenCv22(t *testing.T) {
	...
	xmlFile := "/Users/chrisferdian/Development/backend/project/golang-project/sekawan-backend/app/main_test/data/haarcascade_frontalface_default.xml"
